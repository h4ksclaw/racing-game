...
export class SettingsPanel extends LitElement {
	static styles = css`
		:host {
			...
			z-index: 200; font-family: "Segoe UI", system-ui, -apple-system, sans-serif;
		...
		.panel {
			...
			padding: 28px; width: 340px; max-width: 90vw; max-height: 80vh;
		...
		.close-btn:hover {
			background: rgba(255,51,85,0.15); border-color: rgba(255,51,85,0.3); color: #ff3355;
		}
			...
			<div class="panel">
				...
				<div class="section">
					...
					<div class="setting-row">
						...
						<input type="range" min="60" max="110" .value=${String(this.fov)}
							@input=${(e: Event) => {
				...
				<div class="section">
					...
					<div class="setting-row">
						...
						<input type="range" min="0" max="100" .value=${String(this.volume)}
							@input=${(e: Event) => {
