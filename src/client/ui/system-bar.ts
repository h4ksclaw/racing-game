...
export class SystemBar extends LitElement {
	...
	override render() {
      ...
      ><span class="val">${String(this.seed).padStart(4, "0")}</span>
      <span class="sep">|</span>
      <span class="lbl">TIME</span><span class="val">${this.time}</span>
      <span class="sep">|</span>
      <span class="lbl">WX</span
      ><span class="val">${this.weather.toUpperCase()}</span>
      <span class="sep">|</span>
      <span class="lbl">SURFACE</span
      ><span class="val">${this.surface.toUpperCase()}</span>
      <span class="sep">|</span>
